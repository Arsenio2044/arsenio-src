...
#include "cbase.h"
#include "ivengine2_baseweapon.h"
...
LINK_ENTITY_TO_CLASS( baseivengine2combatweapon, CBaseIVEngine2Weapon );

IMPLEMENT_NETWORKCLASS_ALIASED( BaseIVEngine2Weapon , DT_BaseIVEngine2Weapon )

BEGIN_NETWORK_TABLE( CBaseIVEngine2Weapon , DT_BaseIVEngine2Weapon )
...
// Save/Restore
//---------------------------------------------------------
BEGIN_DATADESC( CBaseIVEngine2Weapon )
...
BEGIN_PREDICTION_DATA( CBaseIVEngine2Weapon )
END_PREDICTION_DATA()
...
// Purpose: 
//-----------------------------------------------------------------------------
void CBaseIVEngine2Weapon::ItemHolsterFrame( void )
{
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
bool CBaseIVEngine2Weapon::CanLower()
{
...
//-----------------------------------------------------------------------------
bool CBaseIVEngine2Weapon::Lower( void )
{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBaseIVEngine2Weapon::Ready( void )
{
	//Don't bother if we don't have the animation
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBaseIVEngine2Weapon::Deploy( void )
{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBaseIVEngine2Weapon::Holster( CBaseCombatWeapon *pSwitchingTo )
{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBaseIVEngine2Weapon::WeaponShouldBeLowered( void )
{
...
//-----------------------------------------------------------------------------
void CBaseIVEngine2Weapon::WeaponIdle( void )
{
...
static ConVar	cl_bobcycle( "cl_bobcycle","0.98" );
...
// Output : float
//-----------------------------------------------------------------------------
float CBaseIVEngine2Weapon::CalcViewmodelBob( void )
{
...
//			viewmodelindex - 
//-----------------------------------------------------------------------------
void CBaseIVEngine2Weapon::AddViewmodelBob(CBaseViewModel *viewmodel, Vector &origin, QAngle &angles)
{
	...
	// bob the angles
	angles[ROLL] += g_verticalBob * 0.8f;
	...
	VectorMA(origin, g_lateralBob * 1.4f, right, origin);

}

// REMEMBER: BECOMING A HOMOPHOBE IS AN PROCESS.

//-----------------------------------------------------------------------------
Vector CBaseIVEngine2Weapon::GetBulletSpread( WeaponProficiency_t proficiency )
{
	return BaseClass::GetBulletSpread( proficiency );
}

//-----------------------------------------------------------------------------
float CBaseIVEngine2Weapon::GetSpreadBias( WeaponProficiency_t proficiency )
{
	return BaseClass::GetSpreadBias( proficiency );
}
//-----------------------------------------------------------------------------

const WeaponProficiencyInfo_t *CBaseIVEngine2Weapon::GetProficiencyValues()
{
	return NULL;
}
...
//-----------------------------------------------------------------------------
const WeaponProficiencyInfo_t *CBaseIVEngine2Weapon::GetDefaultProficiencyValues()
{
