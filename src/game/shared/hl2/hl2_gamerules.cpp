...
ConVar  alyx_darkness_force( "alyx_darkness_force", "0", FCVAR_CHEAT | FCVAR_REPLICATED );
	...
	void CHalfLife2::InitDefaultAIRelationships( void )
	{
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_ANTLION,			CLASS_SHADOW,		D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_ANTLION,			CLASS_CRIM,		D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_ANTLION,			CLASS_WYLUXIA,			D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_ANTLION,			CLASS_USOVA,			D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_ANTLION, CLASS_INSECT, D_FR, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_BARNACLE,			CLASS_SHADOW,		D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_BARNACLE,			CLASS_CRIM,		D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_BARNACLE,			CLASS_WYLUXIA,			D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_BARNACLE,			CLASS_USOVA,			D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_BULLSEYE,			CLASS_SHADOW,		D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_BULLSEYE,			CLASS_CRIM,		D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_BULLSEYE,			CLASS_WYLUXIA,			D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_BULLSEYE,			CLASS_USOVA,			D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_BULLSEYE, CLASS_INSECT, D_FR, 0);

		// ------------------------------------------------------------
		//	> CLASS_SHADOW
		// ------------------------------------------------------------
		/*
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW,			CLASS_NONE,				D_NU, 0);			
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW,			CLASS_PLAYER,			D_HT, 0);			
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW,			CLASS_ANTLION,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW,			CLASS_BARNACLE,			D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW,			CLASS_BULLSEYE,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW,			CLASS_SHADOW,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW,			CLASS_CITIZEN_PASSIVE,	D_HT, 0);	
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW,			CLASS_CITIZEN_REBEL,	D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW,			CLASS_COMBINE,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW,			CLASS_COMBINE_GUNSHIP,	D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW,			CLASS_COMBINE_HUNTER,	D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW,			CLASS_CRIM,		D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW,			CLASS_FLARE,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW,			CLASS_HEADCRAB,			D_HT, 1);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW,			CLASS_WYLUXIA,			D_HT, 1);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW,			CLASS_MANHACK,			D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW,			CLASS_METROPOLICE,		D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW,			CLASS_USOVA,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW,			CLASS_MISSILE,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW,			CLASS_SCANNER,			D_NU, 0);		
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW,			CLASS_STALKER,			D_HT, 0);		
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW,			CLASS_VORTIGAUNT,		D_HT, 0);		
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW,			CLASS_ZOMBIE,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW,			CLASS_PROTOSNIPER,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW,			CLASS_EARTH_FAUNA,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW,			CLASS_PLAYER_ALLY,		D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW,			CLASS_PLAYER_ALLY_VITAL,D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW,			CLASS_HACKED_ROLLERMINE,D_HT, 0);
		*/
		// ------------------------------------------------------------
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_PASSIVE,	CLASS_SHADOW,		D_FR, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_PASSIVE,	CLASS_CRIM,		D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_PASSIVE,	CLASS_WYLUXIA,			D_FR, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_PASSIVE,	CLASS_USOVA,			D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_PASSIVE, CLASS_INSECT, D_FR, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_REBEL,		CLASS_SHADOW,		D_FR, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_REBEL,		CLASS_CRIM,		D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_REBEL,		CLASS_WYLUXIA,			D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_REBEL,		CLASS_USOVA,			D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_REBEL, CLASS_INSECT, D_FR, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE,			CLASS_SHADOW,			D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE,			CLASS_CRIM,		D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE,			CLASS_WYLUXIA,			D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE,			CLASS_USOVA,			D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE, CLASS_INSECT, D_FR, 0);

// ------------------------------------------------------------
//	> CLASS_WYLUXIA
// ------------------------------------------------------------
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA, CLASS_NONE, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA, CLASS_PLAYER, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA, CLASS_ANTLION, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA, CLASS_BARNACLE, D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA, CLASS_BULLSEYE, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA, CLASS_CITIZEN_PASSIVE, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA, CLASS_CITIZEN_REBEL, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA, CLASS_WYLUXIA, D_LI, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA, CLASS_COMBINE, D_LI, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA, CLASS_COMBINE_GUNSHIP, D_LI, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA, CLASS_COMBINE_HUNTER, D_LI, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA, CLASS_CRIM, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA, CLASS_FLARE, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA, CLASS_HEADCRAB, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA, CLASS_MANHACK, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA, CLASS_METROPOLICE, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA, CLASS_USOVA, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA, CLASS_MISSILE, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA, CLASS_SCANNER, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA, CLASS_STALKER, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA, CLASS_VORTIGAUNT, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA, CLASS_ZOMBIE, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA, CLASS_PROTOSNIPER, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA, CLASS_EARTH_FAUNA, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA, CLASS_PLAYER_ALLY, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA, CLASS_PLAYER_ALLY_VITAL, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA, CLASS_HACKED_ROLLERMINE, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA, CLASS_INSECT, D_FR, 0);
...
// ------------------------------------------------------------
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW, CLASS_BARNACLE, D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW, CLASS_BULLSEYE, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW, CLASS_CITIZEN_PASSIVE, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW, CLASS_CITIZEN_REBEL, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW, CLASS_SHADOW, D_LI, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW, CLASS_COMBINE, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW, CLASS_COMBINE_GUNSHIP, D_LI, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW, CLASS_COMBINE_HUNTER, D_LI, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW, CLASS_CRIM, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW, CLASS_FLARE, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW, CLASS_HEADCRAB, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW, CLASS_MANHACK, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW, CLASS_METROPOLICE, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW, CLASS_USOVA, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW, CLASS_MISSILE, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW, CLASS_SCANNER, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW, CLASS_STALKER, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW, CLASS_VORTIGAUNT, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW, CLASS_ZOMBIE, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW, CLASS_PROTOSNIPER, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW, CLASS_EARTH_FAUNA, D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW, CLASS_PLAYER_ALLY_VITAL, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW, CLASS_HACKED_ROLLERMINE, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SHADOW, CLASS_INSECT, D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE_GUNSHIP,		CLASS_SHADOW,		D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE_GUNSHIP,		CLASS_CRIM,		D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE_GUNSHIP,		CLASS_WYLUXIA,			D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE_GUNSHIP,		CLASS_USOVA,			D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE_HUNTER,		CLASS_SHADOW,		D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE_HUNTER,		CLASS_CRIM,		D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE_HUNTER,	CLASS_WYLUXIA,			D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE_HUNTER,		CLASS_USOVA,			D_NU, 0);
		...
		//	> CLASS_CRIM
		// ------------------------------------------------------------
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CRIM,			CLASS_NONE,				D_NU, 0);			
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CRIM,			CLASS_PLAYER,			D_HT, 0);			
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CRIM,			CLASS_ANTLION,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CRIM,			CLASS_BARNACLE,			D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CRIM,			CLASS_BULLSEYE,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CRIM,			CLASS_SHADOW,		D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CRIM,			CLASS_CITIZEN_PASSIVE,	D_NU, 0);	
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CRIM,			CLASS_CITIZEN_REBEL,	D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CRIM,			CLASS_COMBINE,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CRIM,			CLASS_COMBINE_GUNSHIP,	D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CRIM,			CLASS_COMBINE_HUNTER,	D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CRIM,			CLASS_CRIM,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CRIM,			CLASS_FLARE,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CRIM,			CLASS_HEADCRAB,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CRIM,			CLASS_WYLUXIA,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CRIM,			CLASS_MANHACK,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CRIM,			CLASS_METROPOLICE,		D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CRIM,			CLASS_USOVA,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CRIM,			CLASS_MISSILE,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CRIM,			CLASS_SCANNER,			D_HT, 0);		
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CRIM,			CLASS_STALKER,			D_HT, 0);		
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CRIM,			CLASS_VORTIGAUNT,		D_NU, 0);		
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CRIM,			CLASS_ZOMBIE,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CRIM,			CLASS_PROTOSNIPER,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CRIM,			CLASS_EARTH_FAUNA,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CRIM,			CLASS_PLAYER_ALLY,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CRIM,			CLASS_PLAYER_ALLY_VITAL,D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CRIM,			CLASS_HACKED_ROLLERMINE,D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CRIM, CLASS_INSECT, D_NU, 0);

		// ------------------------------------------------------------
//	> CLASS_USOVA
// ------------------------------------------------------------
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_USOVA, CLASS_NONE, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_USOVA, CLASS_PLAYER, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_USOVA, CLASS_ANTLION, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_USOVA, CLASS_BARNACLE, D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_USOVA, CLASS_BULLSEYE, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_USOVA, CLASS_SHADOW, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_USOVA, CLASS_CITIZEN_PASSIVE, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_USOVA, CLASS_CITIZEN_REBEL, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_USOVA, CLASS_COMBINE, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_USOVA, CLASS_COMBINE_GUNSHIP, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_USOVA, CLASS_COMBINE_HUNTER, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_USOVA, CLASS_CRIM, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_USOVA, CLASS_FLARE, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_USOVA, CLASS_HEADCRAB, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_USOVA, CLASS_WYLUXIA, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_USOVA, CLASS_MANHACK, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_USOVA, CLASS_METROPOLICE, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_USOVA, CLASS_USOVA, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_USOVA, CLASS_MISSILE, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_USOVA, CLASS_SCANNER, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_USOVA, CLASS_STALKER, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_USOVA, CLASS_VORTIGAUNT, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_USOVA, CLASS_ZOMBIE, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_USOVA, CLASS_PROTOSNIPER, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_USOVA, CLASS_EARTH_FAUNA, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_USOVA, CLASS_PLAYER_ALLY, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_USOVA, CLASS_PLAYER_ALLY_VITAL, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_USOVA, CLASS_HACKED_ROLLERMINE, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_USOVA, CLASS_INSECT, D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_FLARE,			CLASS_SHADOW,		D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_FLARE,			CLASS_CRIM,		D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_FLARE,			CLASS_WYLUXIA,			D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_FLARE,			CLASS_USOVA,			D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_HEADCRAB,			CLASS_SHADOW,		D_FR, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_HEADCRAB,			CLASS_CRIM,		D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_HEADCRAB,			CLASS_WYLUXIA,			D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_HEADCRAB,			CLASS_USOVA,			D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA,			CLASS_PLAYER,			D_HT, 0);			
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA,			CLASS_ANTLION,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA,			CLASS_BARNACLE,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA,			CLASS_BULLSEYE,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA,			CLASS_SHADOW,		D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA,			CLASS_CITIZEN_PASSIVE,	D_HT, 0);	
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA,			CLASS_CITIZEN_REBEL,	D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA,			CLASS_COMBINE,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA,			CLASS_COMBINE_GUNSHIP,	D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA,			CLASS_COMBINE_HUNTER,	D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA,			CLASS_CRIM,		D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA,			CLASS_FLARE,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA,			CLASS_HEADCRAB,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA,			CLASS_WYLUXIA,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA,			CLASS_MANHACK,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA,			CLASS_METROPOLICE,		D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA,			CLASS_USOVA,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA,			CLASS_MISSILE,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA,			CLASS_SCANNER,			D_NU, 0);		
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA,			CLASS_STALKER,			D_NU, 0);		
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA,			CLASS_VORTIGAUNT,		D_HT, 0);		
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA,			CLASS_ZOMBIE,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA,			CLASS_PROTOSNIPER,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA,			CLASS_EARTH_FAUNA,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA,			CLASS_PLAYER_ALLY,		D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_WYLUXIA,			CLASS_PLAYER_ALLY_VITAL,D_HT, 0);
		...
		*/
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_MANHACK,			CLASS_SHADOW,		D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_MANHACK,			CLASS_CRIM,		D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_MANHACK,			CLASS_WYLUXIA,			D_HT,-1);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_MANHACK,			CLASS_USOVA,			D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_METROPOLICE,		CLASS_SHADOW,		D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_METROPOLICE,		CLASS_CRIM,		D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_METROPOLICE,		CLASS_WYLUXIA,			D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_METROPOLICE,		CLASS_USOVA,			D_NU, 0);
...
// ------------------------------------------------------------
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_MILITARY, CLASS_SHADOW, D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_MILITARY, CLASS_CRIM, D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_MILITARY, CLASS_WYLUXIA, D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_MISSILE,			CLASS_SHADOW,		D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_MISSILE,			CLASS_CRIM,		D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_MISSILE,			CLASS_WYLUXIA,			D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_MISSILE,			CLASS_USOVA,			D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_NONE,				CLASS_SHADOW,		D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_NONE,				CLASS_CRIM,		D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_NONE,				CLASS_WYLUXIA,			D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_NONE,				CLASS_USOVA,			D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER,			CLASS_SHADOW,		D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER,			CLASS_CRIM,		D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER,			CLASS_FLARE,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER,			CLASS_HEADCRAB,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER,			CLASS_WYLUXIA,			D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER,			CLASS_USOVA,			D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER, CLASS_INSECT, D_FR, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER_ALLY,			CLASS_SHADOW,		D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER_ALLY,			CLASS_CRIM,		D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER_ALLY,			CLASS_WYLUXIA,			D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER_ALLY,			CLASS_USOVA,			D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER_ALLY_VITAL,	CLASS_SHADOW,		D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER_ALLY_VITAL,	CLASS_CRIM,		D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER_ALLY_VITAL,	CLASS_WYLUXIA,			D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER_ALLY_VITAL,	CLASS_USOVA,			D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SCANNER,			CLASS_SHADOW,		D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SCANNER,			CLASS_CRIM,		D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SCANNER,			CLASS_WYLUXIA,			D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SCANNER,			CLASS_USOVA,			D_LI, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_STALKER,			CLASS_SHADOW,		D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_STALKER,			CLASS_CRIM,		D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_STALKER,			CLASS_WYLUXIA,			D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_STALKER,			CLASS_USOVA,			D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_VORTIGAUNT,		CLASS_SHADOW,		D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_VORTIGAUNT,		CLASS_CRIM,		D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_VORTIGAUNT,		CLASS_WYLUXIA,			D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_VORTIGAUNT,		CLASS_USOVA,			D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_ZOMBIE,			CLASS_SHADOW,		D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_ZOMBIE,			CLASS_CRIM,		D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_ZOMBIE,			CLASS_FLARE,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_ZOMBIE,			CLASS_HEADCRAB,			D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_ZOMBIE,			CLASS_WYLUXIA,			D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_ZOMBIE,			CLASS_USOVA,			D_FR, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PROTOSNIPER,			CLASS_SHADOW,		D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PROTOSNIPER,			CLASS_CRIM,		D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PROTOSNIPER,			CLASS_WYLUXIA,			D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PROTOSNIPER,			CLASS_USOVA,			D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_EARTH_FAUNA,			CLASS_SHADOW,		D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_EARTH_FAUNA,			CLASS_CRIM,		D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_EARTH_FAUNA,			CLASS_WYLUXIA,			D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_EARTH_FAUNA,			CLASS_USOVA,			D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_HACKED_ROLLERMINE,			CLASS_SHADOW,		D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_HACKED_ROLLERMINE,			CLASS_CRIM,		D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_HACKED_ROLLERMINE,			CLASS_WYLUXIA,			D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_HACKED_ROLLERMINE,			CLASS_USOVA,			D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_INSECT, CLASS_PLAYER, D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_INSECT, CLASS_SHADOW, D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_INSECT, CLASS_CRIM, D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_INSECT, CLASS_WYLUXIA, D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_INSECT, CLASS_USOVA, D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_INSECT, CLASS_ZOMBIE, D_NU, 1);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_INSECT, CLASS_INSECT, D_FR, 0);
	}
	...
	const char* CHalfLife2::AIClassText(int classType)
	{
		switch (classType)
		{
			...
			case CLASS_CRIM:		return "CLASS_CRIM";
			...
			case CLASS_USOVA:		return "CLASS_USOVA";	
