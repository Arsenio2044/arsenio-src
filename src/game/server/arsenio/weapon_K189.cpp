...
class CWeaponK189 : public CHLSelectFireMachineGun
{
	DECLARE_DATADESC();
public:
	DECLARE_CLASS( CWeaponK189, CHLSelectFireMachineGun );
...
IMPLEMENT_ACTTABLE(CWeaponK189);
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponK189::Precache( void )
{
	BaseClass::Precache();
}
...
//-----------------------------------------------------------------------------
void CWeaponK189::Equip( CBaseCombatCharacter *pOwner )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponK189::FireNPCPrimaryAttack( CBaseCombatCharacter *pOperator, Vector &vecShootOrigin, Vector &vecShootDir )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponK189::Operator_ForceNPCFire( CBaseCombatCharacter *pOperator, bool bSecondary )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponK189::Operator_HandleAnimEvent( animevent_t *pEvent, CBaseCombatCharacter *pOperator )
{
	switch( pEvent->event )
	{
...
// Output : Activity
//-----------------------------------------------------------------------------
Activity CWeaponK189::GetPrimaryAttackActivity( void )
{
	if ( m_nShotsFired < 2 )
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponK189::AddViewKick( void )
{
...
// Output : int
//-----------------------------------------------------------------------------
int CWeaponK189::WeaponRangeAttack2Condition( float flDot, float flDist )
{
...
//-----------------------------------------------------------------------------
const WeaponProficiencyInfo_t *CWeaponK189::GetProficiencyValues()
{
