...
//
// Purpose: The downtrodden rantoss of City 17. Timid when unarmed, they will
...
//-----------------------------------------------------------------------------
// Rantos expression types
//-----------------------------------------------------------------------------
enum RantosExpressionTypeRantoss_t
{
...
class CNPC_RANTOS : public CNPC_PlayerCompanion
{
	DECLARE_CLASS( CNPC_RANTOS, CNPC_PlayerCompanion );
public:
	CNPC_RANTOS()
	 :	m_iHead( -1 )
	{
	...
	void			Precache();
	void			PrecacheAllOfType( RantosType_t );
	void			Spawn();
	void			PostNPCInit();
	virtual void	SelectModel();
	void			SelectExpressionTypeRantos();
	void			Activate();
...
private:
	...
	RantosType_t	m_Type;
	RantosExpressionTypeRantoss_t	m_ExpressionTypeRantos;
...
//---------------------------------------------------------
//---------------------------------------------------------
inline bool CNPC_RANTOS::NearCommandGoal()
{
...
//---------------------------------------------------------
//---------------------------------------------------------
inline bool CNPC_RANTOS::VeryFarFromCommandGoal()
{
...
//
//==============================================================================
#define CITIZEN_RESPONSE_DISTANCE			768			// Maximum distance for responding rantoss
...
class CRantosResponseSystem : public CBaseEntity
{
	DECLARE_CLASS( CRantosResponseSystem, CBaseEntity );
public:
	DECLARE_DATADESC();
	...
	void	AddResponseTrigger( rantosresponses_t	iTrigger );
