...
//=========================================================
bool CBaseShadowNPC::NoFriendlyFire( void )
{
	if ( !m_pSquad )
	{
		return true;
...
void CBaseShadowNPC::TraceAttack( const CTakeDamageInfo &info, const Vector &vecDir, trace_t *ptr, CDmgAccumulator *pAccumulator )
{
...
bool CBaseShadowNPC::ShouldGib( const CTakeDamageInfo &info )
{
...
void CBaseShadowNPC::Precache( void )
{
...
//-----------------------------------------------------------------------------
bool CBaseShadowNPC::CorpseGib( const CTakeDamageInfo &info )
{
	CEffectData	data;
...
int	CBaseShadowNPC::IRelationPriority( CBaseEntity *pTarget )
{
	return BaseClass::IRelationPriority( pTarget );
}

void CBaseShadowNPC::EjectShell( const Vector &vecOrigin, const Vector &vecVelocity, float rotation, int iType )
{
	CEffectData	data;
...
// scripted sequence
int CBaseShadowNPC::SelectDeadSchedule()
{
