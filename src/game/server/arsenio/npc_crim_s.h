...
//
// Purpose: The downtrodden crimss of City 17. Timid when unarmed, they will
...
//-----------------------------------------------------------------------------
// Crims expression types
//-----------------------------------------------------------------------------
enum CrimsExpressionTypeCrimss_t
{
...
class CNPC_CRIMS : public CNPC_PlayerCompanion
{
	DECLARE_CLASS( CNPC_CRIMS, CNPC_PlayerCompanion );
public:
	CNPC_CRIMS()
	 :	m_iHead( -1 )
	{
	...
	void			Precache();
	void			PrecacheAllOfType( CrimsType_t );
	void			Spawn();
	void			PostNPCInit();
	virtual void	SelectModel();
	void			SelectExpressionTypeCrims();
	void			Activate();
...
private:
	...
	CrimsType_t	m_Type;
	CrimsExpressionTypeCrimss_t	m_ExpressionTypeCrims;
...
//---------------------------------------------------------
//---------------------------------------------------------
inline bool CNPC_CRIMS::NearCommandGoal()
{
...
//---------------------------------------------------------
//---------------------------------------------------------
inline bool CNPC_CRIMS::VeryFarFromCommandGoal()
{
...
//
//==============================================================================
#define CITIZEN_RESPONSE_DISTANCE			768			// Maximum distance for responding crimss
...
class CCrimsResponseSystem : public CBaseEntity
{
	DECLARE_CLASS( CCrimsResponseSystem, CBaseEntity );
public:
	DECLARE_DATADESC();
	...
	void	AddResponseTrigger( crimsresponses_t	iTrigger );
