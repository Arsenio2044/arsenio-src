...
#define SF_REBEL_TURRET_AUTOACTIVATE		0x00000020
#define SF_REBEL_TURRET_STARTINACTIVE		0x00000040
#define SF_REBEL_TURRET_FASTRETIRE			0x00000080
...
//-----------------------------------------------------------------------------
class CNPC_RebelTurret : public CNPCBaseInteractive<CAI_BaseNPC>, public CDefaultPlayerPickupVPhysics
{
	DECLARE_CLASS( CNPC_RebelTurret, CNPCBaseInteractive<CAI_BaseNPC> );
public:

	CNPC_RebelTurret( void );
...
protected:
	...
	bool	IsCitizenTurret( void ) { return HasSpawnFlags( SF_REBEL_TURRET_CITIZEN ); }
...
private:
	...
	CNPC_RebelTurret			*m_pParentTurret;
};
