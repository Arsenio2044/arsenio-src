...
#include "player.h"
#include "gamerules.h"		// For g_pGameRules shut the fuck up valve nerds.
...
class CWeaponBULK : public CBaseHLCombatWeapon
{
	DECLARE_DATADESC();
public:
	DECLARE_CLASS(CWeaponBULK, CBaseHLCombatWeapon);
...
IMPLEMENT_SERVERCLASS_ST(CWeaponBULK, DT_WeaponBULK)
END_SEND_TABLE()

LINK_ENTITY_TO_CLASS(weapon_bulk, CWeaponBULK);
PRECACHE_WEAPON_REGISTER(weapon_bulk);

BEGIN_DATADESC(CWeaponBULK)
...
acttable_t	CWeaponBULK::m_acttable[] =
{
...
IMPLEMENT_ACTTABLE(CWeaponBULK);

void CWeaponBULK::Precache(void)
{
...
// Input  : *pOperator - 
//-----------------------------------------------------------------------------
void CWeaponBULK::FireNPCPrimaryAttack(CBaseCombatCharacter *pOperator, bool bUseWeaponAngles)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponBULK::Operator_ForceNPCFire(CBaseCombatCharacter *pOperator, bool bSecondary)
{
...
// Output :
//-----------------------------------------------------------------------------
void CWeaponBULK::Operator_HandleAnimEvent(animevent_t *pEvent, CBaseCombatCharacter *pOperator)
{
	switch (pEvent->event)
	{
...
//-----------------------------------------------------------------------------
float CWeaponBULK::GetMinRestTime()
{
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
float CWeaponBULK::GetMaxRestTime()
{
	if (hl2_episodic.GetBool() && GetOwner() && GetOwner()->Classify() == CLASS_COMBINE)
	{
		return 1.5f;
...
// Output :
//-----------------------------------------------------------------------------
bool CWeaponBULK::StartReload(void)
{
...
// Output :
//-----------------------------------------------------------------------------
void CWeaponBULK::FinishReload(void)
{
...
// Output :
//-----------------------------------------------------------------------------
void CWeaponBULK::FillClip(void)
{
	CBaseCombatCharacter *pOwner = GetOwner();
...
//
//-----------------------------------------------------------------------------
void CWeaponBULK::PrimaryAttack(void)
{
...
//
//-----------------------------------------------------------------------------
void CWeaponBULK::SecondaryAttack(void)
{
	CBasePlayer *pPlayer = ToBasePlayer(GetOwner());
...
void CWeaponBULK::ShotgunFire(int PelletsNum, int PelletDamage, bool UsePump)
{
	CBasePlayer *pPlayer = ToBasePlayer(GetOwner());
...
void CWeaponBULK::SwitchFiremode(void)
{
	CBasePlayer *pPlayer = ToBasePlayer(GetOwner());
...
//-----------------------------------------------------------------------------
void CWeaponBULK::ItemPostFrame(void)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponBULK::ItemHolsterFrame(void)
{
	// Must be player held
...
//==================================================
/*
void CWeaponBULK::WeaponIdle( void )
{
//Only the player fires this way so we can cast
