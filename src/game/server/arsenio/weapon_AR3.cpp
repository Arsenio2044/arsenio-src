...
//
// Purpose: The AR3 is the sucessor to the AR2.
//=============================================================================//
...
ConVar sk_weapon_ar3_alt_fire_radius( "sk_weapon_ar3_alt_fire_radius", "10" );
ConVar sk_weapon_ar3_alt_fire_duration( "sk_weapon_ar3_alt_fire_duration", "2" );
ConVar sk_weapon_ar3_alt_fire_mass( "sk_weapon_ar3_alt_fire_mass", "150" );
...
IMPLEMENT_SERVERCLASS_ST(CWeaponAR3, DT_WeaponAR2)
END_SEND_TABLE()
...
void CWeaponAR3::DelayedAttack( void )
{
	...
	CreateCombineBall(	vecSrc, 
						vecVelocity, 
						sk_weapon_ar3_alt_fire_radius.GetFloat(), 
						sk_weapon_ar3_alt_fire_mass.GetFloat(),
						sk_weapon_ar3_alt_fire_duration.GetFloat(),
						pOwner );
...
void CWeaponAR3::FireNPCSecondaryAttack( CBaseCombatCharacter *pOperator, bool bUseWeaponAngles )
{
	...
	float flDuration = RemapValClamped( flAmmoRatio, 0.0f, 1.0f, 0.5f, sk_weapon_ar3_alt_fire_duration.GetFloat() );
	float flRadius = RemapValClamped( flAmmoRatio, 0.0f, 1.0f, 4.0f, sk_weapon_ar3_alt_fire_radius.GetFloat() );
