...
class CMetroZombie : public CAI_BlendingHost<CNPC_BaseZombie>
{
	DECLARE_DATADESC();
	DECLARE_CLASS( CMetroZombie, CAI_BlendingHost<CNPC_BaseZombie> );
...
LINK_ENTITY_TO_CLASS( npc_metrozombie, CMetroZombie );
LINK_ENTITY_TO_CLASS( npc_metrozombie_torso, CMetroZombie );

//---------------------------------------------------------
//---------------------------------------------------------
const char *CMetroZombie::pMoanSounds[] =
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CMetroZombie::Precache( void )
{
	BaseClass::Precache();
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
void CMetroZombie::Spawn( void )
{
	Precache();

	if( FClassnameIs( this, "npc_metrozombie" ) )
	{
		m_fIsTorso = false;
	}
	else
	{
		// This was placed as an npc_metrozombie_torso
		m_fIsTorso = true;
	}
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
void CMetroZombie::PrescheduleThink( void )
{
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
int CMetroZombie::SelectSchedule ( void )
{
...
//-----------------------------------------------------------------------------
void CMetroZombie::FootstepSound( bool fRightFoot )
{
	if( fRightFoot )
	{
...
//-----------------------------------------------------------------------------
void CMetroZombie::FootscuffSound( bool fRightFoot )
{
	if( fRightFoot )
	{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CMetroZombie::PainSound( const CTakeDamageInfo &info )
{
...
//-----------------------------------------------------------------------------
const char *CMetroZombie::GetMoanSound( int nSound )
{
...
//-----------------------------------------------------------------------------
void CMetroZombie::IdleSound( void )
{
...
//-----------------------------------------------------------------------------
const char *CMetroZombie::GetHeadcrabClassname( void )
{
	return "npc_headcrab";
}
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
const char *CMetroZombie::GetHeadcrabModel( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
const char *CMetroZombie::GetLegsModel( void )
{
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
const char *CMetroZombie::GetTorsoModel( void )
{
...
//---------------------------------------------------------
//---------------------------------------------------------
void CMetroZombie::SetZombieModel( void )
{
...
//---------------------------------------------------------
void CMetroZombie::MoanSound( envelopePoint_t *pEnvelope, int iEnvelopeSize )
{
	if( IsOnFire() )
	{
...
//---------------------------------------------------------
//---------------------------------------------------------
bool CMetroZombie::ShouldBecomeTorso( const CTakeDamageInfo &info, float flDamageThreshold )
{
	if( IsSlumped() ) 
	{
...
//---------------------------------------------------------
//---------------------------------------------------------
void CMetroZombie::GatherConditions( void )
{
...
int CMetroZombie::SelectFailSchedule( int failedSchedule, int failedTask, AI_TaskFailureCode_t taskFailCode )
{
...
int CMetroZombie::TranslateSchedule( int scheduleType )
{
...
Activity CMetroZombie::NPC_TranslateActivity( Activity newActivity )
{
...
//---------------------------------------------------------
//---------------------------------------------------------
void CMetroZombie::OnStateChange( NPC_STATE OldState, NPC_STATE NewState )
{
...
void CMetroZombie::StartTask( const Task_t *pTask )
{
	switch( pTask->iTask )
	{
...
void CMetroZombie::RunTask( const Task_t *pTask )
{
	switch( pTask->iTask )
	{
	case TASK_ZOMBIE_ATTACK_DOOR:
...
bool CMetroZombie::OnObstructingDoor( AILocalMoveGoal_t *pMoveGoal, CBaseDoor *pDoor, 
...
Activity CMetroZombie::SelectDoorBash()
{
...
//---------------------------------------------------------
void CMetroZombie::Ignite( float flFlameLifetime, bool bNPCOnly, float flSize, bool bCalledByLevelDesigner )
{
 	if( !IsOnFire() && IsAlive() )
	{
...
//---------------------------------------------------------
//---------------------------------------------------------
int CMetroZombie::OnTakeDamage_Alive( const CTakeDamageInfo &inputInfo )
{
#ifndef HL2_EPISODIC
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
bool CMetroZombie::IsHeavyDamage( const CTakeDamageInfo &info )
{
#ifdef HL2_EPISODIC
...
bool CMetroZombie::IsSquashed( const CTakeDamageInfo &info )
{
	if( GetHealth() > 0 )
	{
		return false;
...
//---------------------------------------------------------
//---------------------------------------------------------
void CMetroZombie::BuildScheduleTestBits( void )
{
...
AI_BEGIN_CUSTOM_NPC( npc_metrozombie, CMetroZombie )
