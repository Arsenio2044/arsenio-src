...
ConVar hopper_grabtime( "hopper_grabtime", "0.25", FCVAR_REPLICATED, 
	"Time it takes to pull up a hopper mine." );
...
void CBounceBomb::SearchThink()
{
	...
	if (m_pConstraint && gpGlobals->curtime - m_flTimeGrabbed >= hopper_grabtime.GetFloat())
	{
