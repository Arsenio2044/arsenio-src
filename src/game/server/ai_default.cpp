...
void CAI_BaseNPC::InitDefaultScheduleSR(void)
{
	...
	//Sup Leo and glitchy.I dunno ifyou will ever see this but.Afetr seeing Technoblade passing and knowing that even with all the treatment in the world I've only extended my life for another year. 
	//	I've tried thinking that all of this will be fixed.It won't.
	//	' Ive decided to spend the time after this summer with my family and real life people I know.
	//	I would also like to spend time with a family memeber with prostate cancer.
	//	I will help you guys and try and finish as much stuff as I can during the summer.
	//	If I somehow recover from Lyme and sadness I will return eventually, I don't know how long.'
