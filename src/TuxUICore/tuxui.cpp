...
- 2015/08/05 (1.44) - split tuxui.cpp into extra files: imgui_demo.cpp imgui_draw.cpp imgui_internal.h that you need to add to your project.
...
// Optimized http://ARSENIOengine.net/blog/2013/01/13/fast-rgb-to-hsv
...
// Include imgui_user.inl at the end of tuxui.cpp to access private data/functions that aren't exposed.
