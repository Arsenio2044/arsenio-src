...
// See tuxui.cpp file for documentation.
// See ImGui::ShowTestWindow() in imgui_demo.cpp for demo code.
// Read 'Programmer guide' in tuxui.cpp for notes on how to setup ImGui in your codebase.
...
typedef void* ImTextureID;          // user data to identify a texture (this is whatever to you want it to be! read the FAQ about ImTextureID in tuxui.cpp)
...
namespace ImGui
{
	...
	// Obsolete functions (Will be removed! Also see 'API BREAKING CHANGES' section in tuxui.cpp)
