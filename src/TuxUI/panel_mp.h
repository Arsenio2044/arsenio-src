...
class Panel_Multiplayer : public Frame2D
{
	DECLARE_CLASS_SIMPLE(Panel_Multiplayer, Frame2D);

public:
	Panel_Multiplayer(vgui::VPANEL parent, const char* PanelName);
...
private:
	...
	Button_Panel*		m_pBtnCS;
	Button_Panel*		m_pBtnFS;
